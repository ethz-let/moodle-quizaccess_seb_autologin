...
/**
 * Backup code for the quizaccess_seb_autologin plugin.
 *
...
/**
 * Provides the information to backup the seb_autologin quiz access plugin.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_quizaccess_seb_autologin_subplugin extends backup_mod_quiz_access_subplugin {
    ...
    protected function define_quiz_subplugin_structure() {
        ...
        $subplugintablesettings->set_source_table('quizaccess_seb_autologin',
                ['sebautologinquizid' => backup::VAR_ACTIVITYID]);
